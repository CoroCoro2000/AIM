Shader "HDRenderPipeline/UnlitCastShadow"
{
	Properties
	{
...
#define VARYINGS_NEED_POSITION_WS
			...
			#define PackVaryingsType PackVaryingsToPS
						...
						VaryingsMeshType VertMesh(AttributesMesh input)
						{
							...
							output.positionCS = mul(unity_MatrixVP, float4(positionRWS, 1.0));
					...
					void Frag(PackedVaryingsToPS packedInput,out float4 outColor : SV_Target, out float outputDepth : SV_Depth)
					{
