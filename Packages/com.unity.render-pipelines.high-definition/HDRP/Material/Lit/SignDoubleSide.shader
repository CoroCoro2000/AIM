...
/*----------------------------------------------------*/
//〔更新履歴〕
// 2019/2/12 〔根本 勇斗〕新規作成
/*====================================================*/
Shader "HDRenderPipeline/SignDoubleSide"
{
	Properties
	{
	...
	_BacKColorMap("BackColorMap",2D)="white"{}
...
#include "../../ShaderPass/VertMesh.hlsl"
	...
	)
	{
		...
		if (!facing)
			surfaceData.baseColor = tex2D(_BackColorMap,input.texCoord0).rgb;
