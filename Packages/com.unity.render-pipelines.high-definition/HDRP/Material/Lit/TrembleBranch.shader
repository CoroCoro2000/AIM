/*======================================================================*/
//内容			：揺れる葉のShader
//ファイル		：TrembleLeaf.shader
//
// Copyright (C) 製作者 (根本 勇斗) All Rights Reserved.
/*----------------------------------------------------------------------*/
// [更新履歴]
// 2018/10/15 [根本 勇斗] ファイル作成　サイクルに従って頂点を移動させる処理
// 2018/10/17 [根本 勇斗] ライティングがおかしかった問題を修正
// 2018/10/19 [根本 勇斗] GPUインスタンシングを使用し、バッチングでメッシュが結合され動きが変になっていたのを修正
// 2019/02/06 [根本 勇斗] HDRP用にコードを修正
/*======================================================================*/
Shader "HDRenderPipeline/TrembleBranch"
{
	Properties
	{
	...
	/*--動きに関する値--*/
	_DelayTime("DelayTime",Float) = 1.0
		_WaveCycleX("Wave CycleX", Range(0.0,10.0)) = 1.0
		_WaveAmountX("Wave AmountX", Range(0,1.0)) = 0.001
		_WaveCycleY("Wave CycleY", Range(0.0,10.0)) = 1.0
		_WaveAmountY("Wave AmountY", Range(0,1.0)) = 0.001
		_WaveCycleZ("Wave CycleZ", Range(0.0,10.0)) = 1.0
		_WaveAmountZ("Wave AmountZ", Range(0,1.0)) = 0.001
		_WaveEffectTex("WaveEffectTex",2D) = "White"{}
	/*-----------------*/
...
#include "LitData.hlsl"
#include "../../ShaderPass/TrembleBranchGBufferPass.hlsl"
		ENDHLSL
	}
...
#include "ShaderPass/LitDepthPass.hlsl"
#include "LitData.hlsl"
#include "../../ShaderPass/TrembleBranchDepthPass.hlsl"
		ENDHLSL
	}
